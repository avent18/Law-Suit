...
// JavaScript for Sign In and Sign Out functionality
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Simulate login on Sign In click
    signinBtn.addEventListener("click", function () {
      localStorage.setItem("user", JSON.stringify({ name: "Pragya" }));
      updateAuthDisplay();
    });
    ...
    signOutBtn.addEventListener("click", function () {
      ...
      updateAuthDisplay();  // this brings back the Sign In button
    });
